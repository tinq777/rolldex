...
- 56 techniques, each linked to a real, freely-available YouTube instructional from a
  credible instructor (Lachlan Giles, Chewjitsu, John Danaher, Roger Gracie, Marcelo
  Garcia, Jean Jacques Machado, Stephan Kesting, Evolve University, Caio Terra, and
  others)
- Self-Defense is a deliberately separate category from the sport positions above —
  standing headlock and bear-hug escapes, the kind of thing a Gracie Combatives-style
  curriculum covers that pure sport BJJ often skips
...
## Why these videos
All 56 were individually verified via web search to be real, currently-live YouTube
videos from established BJJ instructors/channels — not generated or guessed IDs.
Descriptions are written in original language, not copied from any source.
